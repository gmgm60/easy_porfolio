...
import 'package:easy_porfolio/core/services/messaging_service/toast/src/debug.dart';
import 'package:easy_porfolio/core/services/messaging_service/toast/src/toast_list_item_notifer.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';

typedef ToastListItemBuilder<T> =
    Widget Function(
...
class ToastListOverlay<T> extends StatefulWidget {
  ...
  static ToastListOverlayState of<T>(BuildContext context) {
    ...
    final _ToastListScope scope = context
        .dependOnInheritedWidgetOfExactType<_ToastListScope>()!;
...
class ToastListOverlayState<T> extends State<ToastListOverlay<T>> {
  ...
  Widget build(BuildContext context) {
    return _ToastListScope(toastListOverlayState: this, child: widget.child);
  }
