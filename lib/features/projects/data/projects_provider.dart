...
final projectsProvider = Provider<List<Project>>((ref) {
  return [
    Project(
      ...
      imageUrl: 'https://picsum.photos/seed/urbanoasis/400/300',
      // Placeholder
      isFeatured: true,
      screenshots: [],
      technologies: [],
    ...
    Project(
      ...
      imageUrl: 'https://picsum.photos/seed/zenretreat/400/300',
      // Placeholder
      isFeatured: true,
      screenshots: [],
      technologies: [],
    ...
    Project(
      ...
      imageUrl: 'https://picsum.photos/seed/ecoliving/400/300',
      // Placeholder
      screenshots: [],
      technologies: [],
    ),
    Project(
      ...
      imageUrl: 'https://picsum.photos/seed/techhub/400/300',
      // Placeholder
      screenshots: [],
      technologies: [],
    ),
    Project(
      ...
      description:
          'A mobile application designed to help users track their fitness activities, set goals, and monitor progress. Built with React Native, it features a user-friendly interface and integrates with various fitness trackers.',
      imageUrl: 'https://picsum.photos/seed/fitnessapp/400/300',
      // Placeholder
      screenshots: [
...
final projectDetailsProvider = Provider.autoDispose.family<Project?, String>((
  ref,
  id,
) {
  final projects = ref.watch(projectsProvider);
