...
import 'package:easy_porfolio/features/projects/presentation/admin/widgets/project_card_widget.dart';
...
class _EmptyProjectFallback extends StatelessWidget {
  const _EmptyProjectFallback({super.key, required this.spacing});
